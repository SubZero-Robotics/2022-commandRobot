 ...
 * @see InstantCommand
 */
class ShooterLowShoot : public frc2::CommandHelper<frc2::CommandBase, ShooterLowShoot> {
 public:
  explicit ShooterLowShoot(CargoSubsystem* subsystem, frc::XboxController* controller);
