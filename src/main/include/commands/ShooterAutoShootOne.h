 ...
 * @see InstantCommand
 */
class ShooterAutoShootOne : public frc2::CommandHelper<frc2::CommandBase, ShooterAutoShootOne> {
 public:
  explicit ShooterAutoShootOne(CargoSubsystem* subsystem, frc::XboxController* controller);
